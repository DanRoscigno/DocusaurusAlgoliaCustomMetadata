...
5. The following types of conversions are currently supported (accuracy loss is guaranteed by the user).
   ...
   - Convert DATETIME to DATE(only year-month-day information is retained, i.e.  `2019-12-09 21:47:05` to `2019-12-09`)
   - Convert DATE to DATETIME (set hour, minute, second to zero, For example: `2019-12-09` to `2019-12-09 00:00:00`)
