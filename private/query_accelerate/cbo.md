...
Basic statistics are stored in the `_statistics_.table_statistic_v1` table. You can view this table in the `_statistics_` database of your CelerData cluster.
