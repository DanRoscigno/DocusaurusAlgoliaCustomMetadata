...
CelerData supports type conversion among BITMAP, STRING, ARRAY, and Column.
 ...
 **The unnest() function can take multiple arrays of different types and lengths.** For more information, see [unnest()](../sql-reference/sql-functions/array-functions/unnest.md).
